...
define('SW_ADMIN_PASSWORD','lgutanay');
...
define('SW_PROJECT_TITLE', 'Residency');
...
define('SW_PROJECT_PASSWORD', 'kenny');

// Automatic addition of parameter SW_DB_TYPE
define('SW_DB_TYPE', 'existingconnection');

// Automatic addition of parameter SW_HTTP_BASEDIR
