...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 10, 2018 at 08:44 AM
...
CREATE TABLE `cap_user` (
  ...
  `password_hash` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password_reset_token` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(20, 'John', 'Paul', 'Paul', 0, 'JOHNP', '', '$2y$13$/9ZN20Q9ZzOsqOiIJvXrkepEfhSSIg8pbmlcUssm3c8jEBL0nXtEq', NULL, 'JOHN@gii.com', 10, 1515371178, 1515371178),
(21, 'christian jake', 'de leon', 'del mundo', 0, 'ceej_', '', '$2y$13$kqvzpfBtjjM7IRv0yZHelOugfxP1o.yQJEeiD/cLV2piPkuQFt7CG', NULL, 'jkdlmnd@gmail.com', 10, 1515556054, 1515556054),
(22, 'edrian', 'mojar', 'racraquin', 0, 'dominic', '', '$2y$13$ytgMLg/aWWB3SAeHnhduEuQgVXSx5HS1t2W5e3BCpKrKWFk.7mrX2', NULL, 'edrianracraquin1124@gmail.com', 10, 1515557216, 1515557216);
